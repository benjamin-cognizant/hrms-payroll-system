...
public class AppraisalRecord {
    ...
    public String getAppraisalCycle() { return appraisalCycle; }
    public void setAppraisalCycle(String appraisalCycle) { this.appraisalCycle = appraisalCycle; }

    public Integer getGoalsAchieved() { return goalsAchieved; }
    public void setGoalsAchieved(Integer goalsAchieved) { this.goalsAchieved = goalsAchieved; }
    ...
    public AppraisalStatus getAppraisalStatus() { return appraisalStatus; }
    public void setAppraisalStatus(AppraisalStatus appraisalStatus) { this.appraisalStatus = appraisalStatus; }
}
